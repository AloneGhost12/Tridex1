...
app.use(session({
    ...
    store: MongoStore.create({
        mongoUrl: process.env.MONGODB_URI || 'mongodb+srv://gff130170:JKMdheztoUBmjDBM@ghost.k971z8m.mongodb.net/?retryWrites=true&w=majority&appName=ghost',
...
mongoose.connect(process.env.MONGODB_URI || 'mongodb+srv://gff130170:JKMdheztoUBmjDBM@ghost.k971z8m.mongodb.net/?retryWrites=true&w=majority&appName=ghost', mongoOptions)
    .then(() => {
