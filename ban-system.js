...
function showBanMessage() {
    ...
    if (!document.getElementById('ban-message')) {
        ...
        banMessage.style.cssText = 'display:flex; position:fixed; top:0; left:0; width:100vw; height:100vh; background:rgba(0,0,0,0.8); z-index:2000; align-items:center; justify-content:center;';
